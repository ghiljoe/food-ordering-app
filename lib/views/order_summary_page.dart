                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      menuController.orderItems.length > 0
                          ? Column(
                              children: [
                                ...menuController.orderItems.map((orderItem) =>
                                    Column(
                                      children: [
                                        SizedBox(
                                          height: 5,
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              '₱ ${menuController.getTotalPriceWithTaxOrderSummary(orderItem).toStringAsFixed(2)}',
                                              style: TextStyle(
                                                  fontSize: 18,
                                                  fontWeight: FontWeight.bold),
                                            ),
                                ...
                                Obx(
                                  () => menuController.isValidVoucher.isTrue
                                      ? Container(
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '₱ ${menuController.order.totalAmount.toString()}',
                                      style: TextStyle(
                                          fontSize: 20,
                                          color: Colors.black,
                                          fontWeight: FontWeight.bold),
